...
<div on:click={() => selectTab($note.id)} class="h-8 w-16 text-center rounded flex border-solid border-2 flex-nowrap cursor-pointer border-black {$note.id == $selected ? "opacity-100" : "opacity-50" } ">
